...
namespace Todo.Services
{
    public static class ApplicationDbContextConvenience
    {
        ...
        {
            return dbContext.TodoLists.Include(todoList => todoList.Owner)
                            .Include(todoList => todoList.Items)
                            .Where(todoList => todoList.Owner.Id == userId ||
                                               todoList.Items.Any(todoItem => todoItem.ResponsibleParty.Id == userId));
        }
